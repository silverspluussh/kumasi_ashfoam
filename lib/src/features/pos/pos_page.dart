...
class _PosViewState extends ConsumerState<PosView> {
                    ...
                    children: [
                      FCard(
                        ...
                        child: SizedBox(
                          ...
                          child: _orderSummary(cartSummary, context, cartItems),
                        ),
                      ),
                      FCard(
                        ...
                        child: SizedBox(
                          width: double.infinity,
                          child: _orderDetails(itemStyle, cartItems),
                        ),
                      ),
                    ],
                  )
      ...
      children: [
        Column(
          ...
          children: [
            ...
            Text("Create sale orders and invoices"),
          ],
        ),
      ],
    );
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
              ...
              Expanded(
                child: CustomField(
                  ...
                  controller: TextEditingController(
                    text: cartSummary['subtotal']?.toStringAsFixed(2),
                  ),
                  readOnly: true,
                  leading: Text("GHS"),
                ),
          ...
          if (cartSummary['taxes'] != null)
            Row(
              spacing: 15,
              children: [
                for (var tax in (cartSummary['taxes'] as List))
                  Expanded(
                    child: CustomField(
                      lable: "${tax['name']} (${tax['percentage']}%)",
                      controller: TextEditingController(
                        text: (tax['amount'] as double).toStringAsFixed(2),
                      ),
                      readOnly: true,
                      leading: const Text("GHS"),
                    ),
                  ),
              ],
            ),
            ...
            children: [
              Expanded(
                child: CustomField(
                  lable: "Grand Total",
                  controller: TextEditingController(
                    text: cartSummary['grandTotal']?.toStringAsFixed(2),
                  ),
                  readOnly: true,
          ...
          Row(
            ...
            children: [
              ...
              Expanded(
                child: CustomField(
                  lable: "Created By",
                  hint: "Name of the person creating the order",
          ...
          FCheckbox(
            ...
            onChange: (v) =>
                ref.read(posInvoiceRequestedProvider.notifier).state = v,
          ),
                ...
                onPress: cartItems.isEmpty
                    ...
                    : () async {
                        if (_customerNameController.text.isEmpty) {
                          Toastification().show(
                            context: context,
                            title: const Text('Please enter customer name'),
                        ...
                        final result = await ref
                            .read(createPOSOrderProvider.notifier)
                            .createOrder(
                              customerName: _customerNameController.text,
                              customerPhone: _customerPhoneController.text,
                              paymentMethod: _paymentMethodController.text,
                              channel: 'Retail', // Default channel
                              createdByManual: _createdByController.text,
                        ...
                        if (result != null && context.mounted) {
                          ...
                          showDialog(
                            ...
                            builder: (context) =>
                                OrderSuccessDialog(order: order, items: items),
                          );
                          Toastification().show(
                            context: context,
                          ...
                          ref.read(posInvoiceRequestedProvider.notifier).state =
                              false;
                        }
                      },
  ...
  Widget _orderDetails(TextStyle? itemStyle, List<dynamic> cartItems) {
    return Column(
      children: [
        SizedBox(height: 20),
        Row(
          ...
          SizedBox(
            ...
            child: Center(
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Icon(FIcons.shoppingCart, size: 50, color: Colors.red),
                  SizedBox(height: 10),
                  Text(
        ...
        for (var item in cartItems)
          Row(
            ...
            children: [
              ...
              Text("GH¢ ${item.discountAmount.toStringAsFixed(2)}"),
